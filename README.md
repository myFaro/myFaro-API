...
Provide myFaro with a trigger to start processing an action for one or more objects of a certain object class.   Each supported `<application>` has its own endpoint eg. /api/v1/webhooks/brokercloud
